...
<!-- SRC -->
[dockerfile]: ''blob/master/platform/viewer/.recipes/OpenResty-Orthanc/dockerfile
[config-nginx]: ''blob/master/platform/viewer/.recipes/OpenResty-Orthanc/config/nginx.conf
[config-orthanc]: ''blob/master/platform/viewer/.recipes/OpenResty-Orthanc/config/orthanc.json
<!-- prettier-ignore-end -->
