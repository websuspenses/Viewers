...
1. Add the tool itself to the repository.
  ...
  Some examples of custom tools can be found in the lesion tracker:   ''tree/master/Packages/ohif-lesiontracker/client/compatibility

2. Add the toolbar button itself to the array of tools in the Toolbar:
  ''blob/574a6d02b090b8b2f020430c5919f8377b8316c6/OHIFViewer/client/components/toolbarSection/toolbarSection.js

3. **A:** Add it to the toolManager (if it's a tool, such as length / angle):

  ''blob/574a6d02b090b8b2f020430c5919f8377b8316c6/Packages/lesiontracker/client/tools.js#L2

  ** --- OR --- **

  **B:** Add it to the functionList if it's a command (e.g. toggle CINE play, or Invert the current viewport):

  ''blob/574a6d02b090b8b2f020430c5919f8377b8316c6/OHIFViewer/client/components/viewer/viewer.js#L12
