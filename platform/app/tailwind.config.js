...
module.exports = {
  ...
  theme: {
    ...
    colors: {
      ...
      // --- 2026 redesign semantic tokens (additive, mirrors platform/ui/tailwind.config.js;
      // consumed via the existing `isActive` light/dark ternary pattern) ---
      accent: {
        DEFAULT: '#0a7c6c',
        hover: '#0c9483',
        light: '#e6f5f3',
