...
function EditUser(props) {
   ...
   const {open,handleClose,initialvalues,setInitialValues,handleSubmit} = props;
	...
	return (
		...
		>
			...
			<DialogActions 
			//className='dialogActionCls'
			>
				<Stack direction="row" spacing={2}>
					<Button variant="contained" color="error" className='borderRadiusCls' onClick={handleClose}>
						Cancel
					</Button>
