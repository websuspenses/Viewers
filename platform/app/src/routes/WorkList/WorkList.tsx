    ...
    return {
      row: [
        ...
        },
        {
          key: 'actions',
          title: 'CTA Viewers',
          content: (<Link to={`/generate-report/${studyInstanceUid}`}>
            <svg fill="#0a7c6c" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 60" width="20px" height="30px">
