              ...
              <Link onClick={clearOldUser} title="Genarate report" to={`/generate-report/${studyInstanceUid}/${modalities}`}>
                {
                  ...
                  // <svg id="Layer_3" width="35px" height="30px" data-name="Layer 3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">

                  //   <path stroke="#0a7c6c" class="cls-1" d="m17.986,3.5h-2.486v-.5c0-.276-.224-.5-.5-.5h-1.586c-.206-.582-.762-1-1.414-1s-1.208.418-1.414,1h-1.586c-.276,0-.5.224-.5.5v.5h-2.486c-.835,0-1.514.679-1.514,1.514v15.972c0,.835.679,1.514,1.514,1.514h11.973c.835,0,1.514-.679,1.514-1.514V5.014c0-.835-.679-1.514-1.514-1.514Zm-8.486,0h1.5c.276,0,.5-.224.5-.5s.225-.5.5-.5.5.224.5.5.224.5.5.5h1.5v1h-5v-1Zm9,17.486c0,.284-.23.514-.514.514H6.014c-.283,0-.514-.23-.514-.514V5.014c0-.284.23-.514.514-.514h2.486v.5c0,.276.224.5.5.5h6c.276,0,.5-.224.5-.5v-.5h2.486c.283,0,.514.23.514.514v15.972Z" />
                  //   <path stroke="#0a7c6c" class="cls-1" d="m8.214,9.293l-.856-.857-.707.707,1.21,1.21c.094.094.221.146.354.146s.26-.053.354-.146l2.068-2.068-.707-.707-1.715,1.714Z" />
                  //   <rect stroke="#0a7c6c" class="cls-1" x="11.857" y="8.643" width="5.285" height="1" />
                  //   <path stroke="#0a7c6c" class="cls-1" d="m8.214,13.293l-.856-.857-.707.707,1.21,1.21c.094.094.221.146.354.146s.26-.053.354-.146l2.068-2.068-.707-.707-1.715,1.714Z" />
                  //   <rect stroke="#0a7c6c" class="cls-1" x="11.857" y="12.643" width="5.285" height="1" />
                  //   <path stroke="#0a7c6c" class="cls-1" d="m8.214,17.293l-.856-.857-.707.707,1.21,1.21c.094.094.221.146.354.146s.26-.053.354-.146l2.068-2.068-.707-.707-1.715,1.714Z" />
                  //   <rect stroke="#0a7c6c" class="cls-1" x="11.857" y="16.643" width="5.285" height="1" />
                  // </svg>
                }
              </Link>
