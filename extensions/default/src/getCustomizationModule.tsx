...
import ProgressDropdownWithNewService from './Components/ProgressDropdownWithNewService';
  ...
  return [
...

    {
      ...
      value: [
        ...
        {
          id: 'progressDropdownWithNewServiceComponent',
          component: ProgressDropdownWithNewService,
        },
      ],
    },
  ];
